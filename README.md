# Standarctix1E System

![Foundry v11](https://img.shields.io/badge/foundry-v11-green)

This system is a standarctix-1e system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the Standarctix1E system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-standarctix-1e-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `standarctix-1e` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `standarctix-1e` and `Standarctix1E` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Standarctix1E System](https://gitlab.com/asacolips-projects/foundry-mods/vue3standarctix-1e) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/standarctix-1e.png)
